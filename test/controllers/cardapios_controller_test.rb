...
class CardapiosControllerTest < ActionController::TestCase
  ...
  test "should create cardapio" do
    assert_difference('Cardapio.count') do
      post :create, cardapio: { categoria_id: @cardapio.categoria_id, descricao: @cardapio.descricao, foto: @cardapio.foto, preco: @cardapio.preco, produto_id: @cardapio.produto_id }
    end
  ...
  test "should update cardapio" do
    patch :update, id: @cardapio, cardapio: { categoria_id: @cardapio.categoria_id, descricao: @cardapio.descricao, foto: @cardapio.foto, preco: @cardapio.preco, produto_id: @cardapio.produto_id }
    assert_redirected_to cardapio_path(assigns(:cardapio))
  end
